...
var spheres = [
  ...
  new Sphere([2, 0, 4], 1, [0, 0, 255], 500, 0.2),
  new Sphere([-2, 0, 4], 1, [0, 255, 0], 10, 0.6),
...
var objects = [
  ...
  new Paraboloid([1, 0, 4], 0.1, 0.1, 25, [0, 0, 255], 500, 0.4),
  new Sadle([-2, 0, 10], 1, 1, 90, [0, 255, 0], 500, 0.6),
  new Sphere([0, -1, 3], 1, [255, 0, 0], 500, 0.6),
  new Sphere([1, 0, 3], 0.1, [255, 255, 255], 500, 0.8),
  new Sphere([-1, 1, 3], 0.1, [255, 255, 255], 500, 0.8),
  new Sphere([0, -5001, 0], 5000, [255, 255, 0], -1, 0.2),
];

var igranje = [new Sphere([0, -1, 3], 1, [255, 0, 0], 500, 0.2)];
...
var set_directional_intensity = document.getElementById(
...
document.addEventListener("keydown", (event) => {
  switch (event.key) {
    ...
    case "ArrowLeft":
      camera_position = add(
        camera_position,
        multiply(-MOVEMENT_SPEED, rotate(camera_rotation, [1, 0, 0]))
      );
      break;
    case "ArrowRight":
      camera_position = add(
    ...
    case "ArrowUp":
      camera_position = add(
        camera_position,
        multiply(MOVEMENT_SPEED, rotate(camera_rotation, [0, 0, 1]))
      );
      break;
    case "ArrowDown":
      camera_position = add(
  ...
  if (event.shiftKey) camera_position[1] -= MOVEMENT_SPEED;
